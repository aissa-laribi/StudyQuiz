...
async def test_patch_question(async_app_client):
    ...
    response = await async_app_client.patch(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/{question_id}", json=data)
    assert response.status_code == 200
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/{question_id}")
    assert response.status_code == 200
...
async def test_create_question(async_app_client):
    ...
    assert response.status_code == 200
    assert response.json()['question_name'] == "Question 1"
    response = await async_app_client.delete(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/{question_id}")
    assert response.status_code == 200
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/{question_id}")
...
async def test_create_full_quiz(async_app_client):
  ...
  "data": [
    ...
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/")
    print(response.json())
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/1")
    assert response.status_code == 200
    assert response.json()['question_name'] == "Question 1"
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/2")
    assert response.status_code == 200
    assert response.json()['question_name'] == "Question 2"
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/3")
    assert response.status_code == 200
...
async def test_get_questions(async_app_client):
  ...
  "data": [
    ...
    assert response.json()[0]['question_name'] == "Question 1"
    assert response.json()[1]['question_name'] == "Question 2"
    assert response.json()[2]['question_name'] == "Question 3"
...
async def test_delete_quiz(async_app_client):
  ...
  "data": [
    ...
    response = await async_app_client.delete(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/batch-delete/")
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/1")
    assert response.status_code == 404
    response = await async_app_client.get(f"/users/{user_id}/modules/{module_id}/quizzes/{quiz_id}/questions/2")
    assert response.status_code == 404
